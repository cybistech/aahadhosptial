                  ...
                  <form action="<?php echo e(url('admin/postlogin')); ?>" method="post">
                     ...
                     <div class="form-group">
                        <label><?php echo e(__('messages.Email')); ?></label>
                         <?php if($type==3): ?>
                        <input type="email" class="form-control" name="email"  id="email" placeholder="<?php echo e(__('messages.Enter').' '.__('messages.Email')); ?>" value="<?php echo e(isset($_COOKIE['email'])?$_COOKIE['email']:'mahajan@gmail.com'); ?>">
                        <?php else: ?>
...
</html><?php /**PATH /home2/freakd1c/public_html/demo/singleclinic/resources/views/admin/login.blade.php ENDPATH**/ ?>