               ...
               <div class="card-body">
                  ...
                  <form action="<?php echo e(url('admin/updatedepartment')); ?>" method="post" novalidate="novalidate" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <img src="<?php echo e(asset('upload/department').'/'.$data->image); ?>" class="imgsize1 departmentimg"/>
                        <?php endif; ?>
                        <div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\clinic Management\resources\views/admin/department/savedepartment.blade.php ENDPATH**/ ?>