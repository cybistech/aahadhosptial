            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="tab-content pl-3 p-1" id="myTabContent">
                     <div class="tab-pane fade <?= $tab_id == 1 ? 'show active' : "" ?> btnsaveoption" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <form action="<?php echo e(url('doctor/updatedoctorprofile')); ?>" method="post"  enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <input type="password" id="password" placeholder="<?php echo e(__('messages.Enter').' '.__('messages.Password')); ?>" class="form-control" required name="password" value="<?php echo e(isset($data->password)?$data->password:''); ?>">
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-md-6">
                           ...
                           <div class="col-md-12 form-group">
                              ...
                              <?php if($doctor_id!=0): ?>
                              <img src="<?php echo e(asset('public/upload/doctor').'/'.$data->image); ?>" class="imgsize1 departmentimg" /> 
                              <?php endif; ?>
                              <div>
                     ...
                     <div class="tab-pane fade <?= $tab_id == 2 ? 'show active' : "" ?> btnsaveoption" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <form action="<?php echo e(url('doctor/updateworkinghours')); ?>" method="post"  enctype="multipart/form-data">
                           <?php echo e(csrf_field()); ?>
                           ...
                           <table class="table table-bordered">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><input type="time" required name="from[]" id="from<?php echo e($i); ?>" class="form-control" value="<?= isset($work->from) ? $work->from : "" ?>" placeholder="8:00" /></td>
                                    <td><input type="time" required name="to[]" id="to<?php echo e($i); ?>" value="<?= isset($work->to) ? $work->to : "" ?>" class="form-control" placeholder="23:00" onchange="checktime(this.value,'<?php echo e($i); ?>')" /></td>
                                 </tr>
                                 <?php $i++; ?>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
                                 <?php else: ?>
                                 ...
                                 <tr>
                                    ...
                                    <td><input type="time" required name="from[]" id="from<?php echo e($i); ?>" class="form-control" value="<?php echo e(time()); ?>" placeholder="8:00" /></td>
                                    <td><input type="time" required name="to[]" id="to<?php echo e($i); ?>" value="" class="form-control" onchange="checktime(this.value,'<?php echo e($i); ?>')" placeholder="23:00" /></td>
                                 </tr>
                                 <?php $i++; ?>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                 <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('doctor.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freaktemplate/public_html/demo/singleclinic/resources/views/doctor/savedoctor.blade.php ENDPATH**/ ?>