			          						...
			          						<div class="tab-part-box">
				          						<?php
			          									if(isset($u->doctors->image)){
			          										$path=asset("upload/doctor").'/'.$u->doctors->image;
			          									}else{
											...
											<div class="tab-profile-main-box">
												<div class="tab-profileimg-main-box">
												  <?php if(Auth::user()->profile_pic): ?>
			          								<img src="<?php echo e(asset('upload/profile').'/'.Auth::user()->profile_pic); ?>">
			          							  <?php else: ?>
			          							    <img src="<?php echo e(asset('upload/profile/profile.png')); ?>">
			          							  <?php endif; ?>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\clinic Management\resources\views/front/myaccount.blade.php ENDPATH**/ ?>