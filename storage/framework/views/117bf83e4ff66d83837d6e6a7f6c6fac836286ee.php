...
<html class="no-js" lang="en">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo e(asset('public/adesign/assets/css/style.css?v=232')); ?>">
      <?php else: ?>
      <link rel="stylesheet" href="<?php echo e(asset('public/adesign/assets/css/rtl.css?v=ASDAS')); ?>">
      <?php endif; ?>
      <link href="<?php echo e(asset('public/fileupload/dist/css/jquery.dm-uploader.min.css')); ?>" rel="stylesheet">
      <link rel="stylesheet" href="<?php echo e(asset('public/front/css/app.min.css?v=212')); ?>">
   ...
   <body class="rtl" onload="gettimezone()">
         ...
         <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse admin-main-menu">
               <ul class="nav navbar-nav">
                  ...
                  <li class="active">
                     <a href="<?php echo e(url('admin/gallery')); ?>"> <i class="menu-icon fa fa-file-image-o"></i><?php echo e(__('messages.Gallery')); ?></a>
                  </li>
                  <li class="active">
                     <a href="<?php echo e(url('admin/review')); ?>"> <i class="menu-icon fa fa-star"></i><?php echo e(__('messages.Review')); ?></a>
                  </li>
                   <li class="active">
                     <a href="<?php echo e(url('admin/subscription')); ?>"> <i class="menu-icon fa fa-gift"></i><?php echo e(__('messages.Subscription')); ?></a>
                  </li>
                  <li class="active">
                  ...
                  <span style="color:#c8c9ce!important">Privacy Policy</span>
                     ...
                     <li>
                        ...
                        <i class="menu-icon fa fa-key"></i>
                        <span><?php echo e(__('messages.Data-Deletion')); ?></span>
                        </a>
                     </li>
                  ...
                  <li class="active">
                     <a href="<?php echo e(url('admin/paymentgateway')); ?>"> <i class="menu-icon fa fa-money"></i><?php echo e(__('messages.Payment Gateway')); ?></a>
                  </li>
                  <li class="active">
      ...
      <!-- <div class="notification">
        <section class="logo">
            <div id="face" >
                <img id="notificationimg" src="<?php echo e(asset('public/upload/profile/profile.png')); ?>" class="notificationimg">
            </div>
        </section>
        <section class="body">
     ...
     <input type="hidden" id="authprofile" value="<?php echo e(Session::get('profile_pic_path')); ?>">
      ...
      <script src="<?php echo e(asset('public/js/admin.js?v=DSEFSD')); ?>"></script>
       <?php echo $__env->yieldContent('footer'); ?>
      
   </body>
</html><?php /**PATH /home2/freakd1c/public_html/demo/singleclinic/resources/views/admin/layout.blade.php ENDPATH**/ ?>