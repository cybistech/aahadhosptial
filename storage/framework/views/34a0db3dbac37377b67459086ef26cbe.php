...
<link rel="stylesheet" href="<?php echo e(asset('front/css/app.min.css?v=25')); ?>">
<?php else: ?>
<link rel="stylesheet" href="<?php echo e(asset('front/css/app.min-rtl.css')); ?>">
<?php endif; ?>
...
<script type="text/javascript" src="<?php echo e(asset('js/chatdata.js?v=dsf')); ?>"></script>
...
<?php echo $__env->make("admin.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\clinic Management\resources\views/admin/chat.blade.php ENDPATH**/ ?>