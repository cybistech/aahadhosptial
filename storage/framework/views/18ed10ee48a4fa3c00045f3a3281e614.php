<?php $__env->startSection('title'); ?>
    <?php if($doctor_id == 0): ?>
        <?php echo e(__('messages.Create').' '.__('messages.Doctors')); ?>

    <?php else: ?>
        <?php echo e(__('messages.Update').' '.__('messages.Doctors')); ?>
                        ...
                        <form action="<?php echo e(url('admin/updatedoctorprofile')); ?>" method="post"  enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <input type="text" id="password" placeholder="<?php echo e(__('messages.Enter').' '.__('messages.Password')); ?>" class="form-control" name="password" value="<?php echo e(isset($data->password)?$data->password:''); ?>">
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-md-6">
                           ...
                           <div class="form-group">
                              <div class="col-md-6">
                                 ...
                                 <input type="text" id="facebook"  placeholder="<?php echo e(__('messages.Enter').' '.__('messages.Facebook ID')); ?>"  class="form-control"  name="facebook" value="<?php echo e(isset($data->facebook_id)?$data->facebook_id:''); ?>">
                              </div>
                              <div class="col-md-6">
                                 <label for="name" class=" form-control-label">
                                 ...
                                 <input type="text" id="twitter_id"  placeholder="<?php echo e(__('messages.Enter').' '.__('messages.Twitter ID')); ?>"  class="form-control"  name="twitter_id" value="<?php echo e(isset($data->twitter_id)?$data->twitter_id:''); ?>">
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-md-6">
                                 ...
                                 <input type="text" id="google_id"  placeholder="<?php echo e(__('messages.Enter').' '.__('messages.Google ID')); ?>"  class="form-control"  name="google_id" value="<?php echo e(isset($data->google_id)?$data->google_id:''); ?>">
                              </div>
                              <div class="col-md-6">
                                 <label for="name" class=" form-control-label">
                                 ...
                                 <input type="text" id="instagram_id"  placeholder="<?php echo e(__('messages.Enter').' '.__('messages.Instagram ID')); ?>"  class="form-control"  name="instagram_id" value="<?php echo e(isset($data->instagram_id)?$data->instagram_id:''); ?>">
                              </div>
                              <div class="col-md-6">
                                ...
                                <input type="text" id="meta_description" required placeholder="<?php echo e(__('messages.Enter').' '.__('messages.meta_description')); ?>"  class="form-control"  name="meta_description" value="<?php echo e(isset($data->meta_description)?$data->meta_description:''); ?>">
                             </div>
                           </div>
                           <div class=" col-md-12 form-group">
                              ...
                              <textarea required name="aboutus" class="ckeditor form-control" id="description" cols="35" rows="20"><?php echo e(isset($data->about_us)?$data->about_us:''); ?></textarea>
                           ...
                           <div class="col-md-12 form-group">
                              ...
                              <textarea required name="service" class="ckeditor form-control" id="servicedoctor" cols="35" rows="20"><?php echo e(isset($data->service)?$data->service:''); ?></textarea>
                           ...
                           <div class="col-md-12 form-group">
                              ...
                              <?php if($doctor_id!=0): ?>
                              <img src="<?php echo e(asset('upload/doctor').'/'.$data->image); ?>" class="imgsize1 btndepartwarning" />
                              <?php endif; ?>
                              <div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\clinic Management\resources\views/admin/doctor/savedoctor.blade.php ENDPATH**/ ?>