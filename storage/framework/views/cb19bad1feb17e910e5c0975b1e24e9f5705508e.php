                      ...
                      <div class="modal-content">
                        <div class="modal-content">
                          <div class="modal-header">
                            <!--<h6 class="modal-title">https://demo.freaktemplate.com/bookappointment/aboutus</h6>-->
                            <!--  <a href= "https://demo.freaktemplate.com/bookappointment/aboutus" class="btn btn-md btn-success" value="Visit" target="#" style="float:right; color:white !important">Visit</a>-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/singleclinic/resources/views/admin/about.blade.php ENDPATH**/ ?>