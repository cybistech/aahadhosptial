                           ...
                           <div class="form-group">
                              ...
                              <div id="uploaded_image">
                                 <div class="upload-btn-wrapper">
                                    ...
                                    <?php
                                       if(isset($data->logo)){
                                           $path=asset('upload/images/')."/".$data->logo;
                                       }
                                       else{
                                           $path=asset('upload/images/logo1.png');
                                       }
                                       ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\clinic Management\resources\views/admin/setting/setting.blade.php ENDPATH**/ ?>