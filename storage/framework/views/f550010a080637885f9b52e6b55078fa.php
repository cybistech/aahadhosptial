               ...
               <div class="card-body">
                  ...
                  <form action="<?php echo e(url('admin/updateservice')); ?>" method="post"  enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <?php if($service_id!=0): ?>
                        <img src="<?php echo e(asset('upload/service').'/'.$servicedata->icon); ?>" class="imgsize1" />
                        <?php endif; ?>
                        <div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\clinic Management\resources\views/admin/service/saveservice.blade.php ENDPATH**/ ?>