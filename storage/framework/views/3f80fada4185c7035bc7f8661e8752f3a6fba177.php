	...
	<div class="footer-main-box">
  	...
  	<div id="gdchat-fixed-bottom-right" class="gdchat-fixed-bottom-right ch1">
		...
		<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha.3/js/bootstrap.js"></script>
	     ...
	     <script type="text/javascript" src="<?php echo e(asset('public/js/front.js?v=fhfghf')); ?>"></script>
		
</body>
</html><?php /**PATH /home/vishal8589/public_html/demo/singleclinic/resources/views/front/layout.blade.php ENDPATH**/ ?>