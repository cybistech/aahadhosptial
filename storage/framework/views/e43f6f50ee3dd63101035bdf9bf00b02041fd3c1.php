        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php endif; ?>
              <h4><?php echo e(__("messages.Data-Deletion")); ?></h4>
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            <h6 class="modal-title"><?php echo e(url('accountdeletion')); ?></h6>
                              <a href= "<?php echo e(url('accountdeletion')); ?>" class="btn btn-md btn-success" value="Visit" target="#" style="float:right; color:white !important">Visit</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/singleclinic/resources/views/admin/data-deletion.blade.php ENDPATH**/ ?>