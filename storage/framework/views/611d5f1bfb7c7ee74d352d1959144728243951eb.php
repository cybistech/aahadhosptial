                     ...
                     <tbody>
                        <?php if(count($data)>0): ?>
                            ...
                            <tr>
                               ...
                               <td>
                                  <a href="javascript:deleterow('deletereview','<?=$d->id?>')" class="btn btn-danger"><?php echo e(__('messages.Delete')); ?></a>
                               </td>
                            </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freaktemplate/public_html/demo/singleclinic/resources/views/admin/doctor/review.blade.php ENDPATH**/ ?>