...
<link rel="stylesheet" href="<?php echo e(asset('public/front/css/app.min.css?v=25')); ?>">
<?php else: ?>
<link rel="stylesheet" href="<?php echo e(asset('public/front/css/app.min-rtl.css')); ?>">
<?php endif; ?>
                              ...
                              <ul class="nav flex-nowrap">
                                 <li class="nav-item list-inline-item mr-0">
                                    <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right" style="top: 30px;    left: -141px;">
                                          <a class="dropdown-item" href="#" role="button" data-toggle="modal" data-target="#chat_new" onclick="chatnewlisthide()"><?php echo e(__("messages.New Chat")); ?></a>
                                       </div>
                                    </div>
                                 </li>
                              </ul>
               ...
               <div class="chat-body">
                <div id="chat_1">
                    <div style="padding: 205px">
                         <img src="<?php echo e(Session::get('profile_pic')); ?>" style="width: 100px;border-radius: 50px;">
                         <h5><?php echo e(isset(Auth::user()->name)?Auth::user()->name:""); ?></h5>
                    </div>
                </div>
                <div id="chat_2" style="display: none">
                      <div class="chat-header">
                         ...
                         <div class="media chat-name align-items-center text-truncate">
                            ...
                            <div class="align-self-center">
                               ...
                               <input type="hidden" name="receiveruid" id="receiveruid" value="<?php echo e(Auth::user()->user_sid); ?>">
                               <input type="hidden" id="created_at" value="0"/>
                               <h6 class="text-truncate mb-0" id="receivername"><?php echo e(isset(Auth::user()->name)?Auth::user()->name:""); ?></h6>
                      ...
                      <div class="chat-content p-2" id="bodymessage" style="height: 450px;" >
...
<div class="mask"></div>
<input type="hidden" id="path_url" value="<?php echo e(url('/')); ?>">
...
<input type="hidden" id="deletemsg" value="<?php echo e(__('messages.Delete')); ?>">
<input type="hidden" id="typingmsg" value="<?php echo e(__('messages.Typing')); ?>">
<input type="hidden" id="currentprofileimage" value="<?php echo e(Session::get('profile_pic')); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startSection("footer"); ?>
<script type="text/javascript" src="<?php echo e(asset('public/js/chatdata.js?v=dsf')); ?>"></script>
<script type="text/javascript">

    getallusers();
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freaktemplate/public_html/demo/singleclinic/resources/views/admin/chat.blade.php ENDPATH**/ ?>