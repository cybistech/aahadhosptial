...
Route::get("server_restart","API\ServerController@server_restart_process");
...
Route::any("listofdepartment","API\ApiController@listofdepartment"); 
...
Route::any("about","API\ApiController@about");
Route::any("privacy","API\ApiController@privacy");