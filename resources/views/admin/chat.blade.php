...
<link rel="stylesheet" href="{{asset('front/css/app.min.css?v=25')}}">
@else
<link rel="stylesheet" href="{{asset('front/css/app.min-rtl.css')}}">
@endif
                                 ...
                                 <li class="nav-item list-inline-item mr-0">
                                    <div class="dropdown">
                                       ...
                                       <div class="dropdown-menu dropdown-menu-right" style="top: 30px;    left: -141px;">
                                          <a class="dropdown-item" href="#" role="button" data-toggle="modal" data-target="#chat_new" onclick="chatnewlisthide()">{{__("messages.New Chat")}}</a>
                                       </div>
                                    </div>
                                 </li>
                              </ul>
                      ...
                      <div class="chat-header">
                         ...
                         <div class="media chat-name align-items-center text-truncate">
                            ...
                            <div class="align-self-center">
                               ...
                               <h6 class="text-truncate mb-0" id="receivername">{{isset(Auth::user()->name)?Auth::user()->name:""}}</h6>
...
@section("footer")
<script type="text/javascript" src="{{asset('js/chatdata.js?v=dsf')}}"></script>
