            ...
            <div class="chats">
               <div class="chat-body">
                    ...
                    <div style="padding: 205px 290px;">
                         <?php
                             if(Auth::user()->profile_pic!=""){
                                $path = asset('upload/profile').'/'.Auth::user()->profile_pic;
                             }else{
                ...
                <div id="chat_2" style="display: none">
                      ...
                      <div class="chat-content p-2" id="bodymessage" style="height: 380px;" >

                     <div class="chat-finished" id="chat-finished"></div>
                  </div>
                  <div class="chat-footer" style="bottom: -100px !important;">
                     <div class="form-row">
                        <div class="col">
                           <div class="input-group">
...
<input type="hidden" id="currenttime"/>
    ...
    <input type="hidden" id="currentprofileimage" value="{{asset('upload/profile').'/'.Auth::user()->profile_pic}}">
@stop
@section("footer")
<script type="text/javascript" src="{{asset('js/chatdata.js?v=mkl')}}"></script>
